...
def uniform_random(database, events, suite_id=None):
...
def min_frequency_random(database, events, suite_id=None):
    assert events is not None and suite_id is not None

    logger.info("Making min_frequency_random selection from {} available events.".format(len(events)))

    min_frequency_events = selection.get_min_frequency_events(database, events, suite_id)
...
def min_frequency_deterministic(database, events, suite_id=None):
    assert events is not None and suite_id is not None
...
def frequency_weighted(database, events, suite_id=None):
    assert events is not None and suite_id is not None
...
def gaussian_random(database, events, suite_id=None):
    assert events is not None and suite_id is not None
